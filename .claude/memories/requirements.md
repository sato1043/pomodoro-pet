...
- Scene行: meadow/seaside/parkの3アイコンボタン（山/波/木のSVGアイコン）+ 右端にLocationボタン（地球アイコン、`weather-location`）。クリックでWeatherPanelを閉じてWorldMapModalを開く。WorldMapModal閉じるとWeatherPanelに復帰
